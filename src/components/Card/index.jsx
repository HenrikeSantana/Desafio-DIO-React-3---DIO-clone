    ...
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          ...
          <div>
            <h4>Henrique Alves Sant'Ana</h4>
            <p>Há 15 minutos</p>
          </div>
        </UserInfo>
        <PostInfo>
          <h4>Desafio-Dio-JS---Pokedex </h4>
          <p>
            Projeto realizado para criar uma pokedex basica utilizando dos
            conhecimentos desenv...<strong>Saiba Mais</strong>
          </p>
        </PostInfo>
        <HasInfo>
